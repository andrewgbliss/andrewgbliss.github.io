...
date: "2025-11-08"
title: "Game Desing Document"
tagline: "The game design document for your game"
...
This is the game design document you can fill out to plan your game.
...
- How is it different from all other games?
...
- Premium purchase?
- F2P? How do you justify this within the design?
...
- Tablet or phone?
- 2D or 3D?
- Unreal, Godot, Unity, Javascript, Custom?
- How long to make
- How big a team?
...
- How does this support player goals?
- What emergent results do you expect/hope to see?
- If F2P, where are the monetization points?
...
- How are different kinds of interactivity used?
- What is the player doing moment-by-moment?
- How does the player move through the world?
- How does physics/combat/etc. work?
