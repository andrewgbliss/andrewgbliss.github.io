...
| #   | App                                                                                                       |
| --- | --------------------------------------------------------------------------------------------------------- |
| 1   | Counter — show count and button that increments count [View Component](/counter)                          |
| 2   | Todo List — add, complete, delete, filter by status, persist to localStorage [View Component](/todos)     |
| 3   | Full Auth App — register/login/logout, protected routes, JWT or session handling [View Component](/login) |
