    ...
    <>
      <div className="min-h-screen pt-16 bg-linear-to-b from-slate-900 via-slate-800 to-slate-900 text-white">
        <div className="container mx-auto max-w-4xl page-p py-16">
          <h1 className="text-4xl font-bold p-2">Terms &amp; Conditions</h1>{" "}
          <p className="p-2">
            ...
            property rights related to it, still belong to {website.name}.
          </p>{" "}
          <p className="p-2">
            {website.name} is committed to ensuring that the app is as useful
          ...
          <p className="p-2">
            Our app stores and processes personal data that you have provided to
            us, in order to provide our Service. It&apos;s your responsibility
            ...
            your phone&apos;s security features and it could mean that the app
          ...
          <div>
            ...
            <ul className="p-2 list-disc list-inside">
              <li>
                <a
                  href="https://support.google.com/adspolicy/answer/54818?hl=en"
                  target="_blank"
          ...
          <p className="p-2">
            ...
            {website.name} will not take responsibility for. Certain functions
            ...
            network provider, but {website.name} cannot take responsibility for
          ...
          <p className="p-2">
            Along the same lines, {website.name} cannot always take
            ...
            you can&apos;t turn it on to avail the Service, {website.name}{" "}
            cannot accept responsibility.
          </p>{" "}
          <p className="p-2">
            With respect to {website.name}&apos;s responsibility for your use of
