    ...
    <>
      <div className="min-h-screen pt-16 bg-linear-to-b from-slate-900 via-slate-800 to-slate-900 text-white">
        <div className="container mx-auto max-w-4xl page-p py-16">
          ...
          <p className="p-2">
            At {website.name}, accessible from
            {website.url}, one of our main priorities is the privacy of our
          ...
          <p className="p-2">
            ...
            that they shared and/or collect in {website.name}. This policy is
          ...
          <h2 className="text-3xl font-bold p-2">Consent</h2>
          ...
          <h2 className="text-3xl font-bold p-2">Information we collect</h2>
          ...
          <h2 className="text-3xl font-bold p-2">Log Files</h2>

          <p className="p-2">
            {website.name} follows a standard procedure of using log files.
          ...
          <h2 className="text-3xl font-bold p-2">Cookies and Web Beacons</h2>
          ...
          <h2 className="text-3xl font-bold p-2">Our Advertising Partners</h2>
          ...
          <p className="p-2">
            ...
            respective advertisements and links that appear on Zero Fall
            Studios, which are sent directly to users browser. They
          ...
          <p className="p-2">
            Note that {website.name} has no access to or control over these
          ...
          <p className="p-2">
            {website.name} Privacy Policy does not apply to other advertisers or
          ...
          <h2 className="text-3xl font-bold p-2">Childrens Information</h2>
